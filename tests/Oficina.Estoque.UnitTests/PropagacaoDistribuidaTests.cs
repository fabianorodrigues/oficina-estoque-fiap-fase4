...
using Oficina.Estoque.Infrastructure.Observability;
...
public class EnvelopeComContextoDeTraceTests
{
    ...
    public void Deve_injetar_traceparent_quando_existe_activity()
    {
        ...
        var body = MessageJson.Envelope(
            EstoqueMessageTypes.EstoqueReservado,
            Guid.NewGuid(),
            "correlacao-1",
            causationId: null,
...
public class MessagingTelemetryTests
{
    ...
    public void Consumo_deve_herdar_o_contexto_do_span_de_envio()
    {
        ...
        using var activity = MessagingTelemetry.StartInboxConsume(inbox, "oficina-estoque-comandos.fifo");
    ...
    private static string CorpoComTrace(string? traceparent)
    {
        var envelope = new
        {
            ...
            messageType = EstoqueMessageTypes.ReservarEstoque,
            schemaVersion = 1,
