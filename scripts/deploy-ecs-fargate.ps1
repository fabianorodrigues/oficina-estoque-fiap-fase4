...
$runtimeSecrets = @(Sec "ConnectionStrings__OficinaEstoqueDb" "$($runtimeSecret):ConnectionString::")
$migrationSecrets = @(Sec "ConnectionStrings__OficinaEstoqueDb" "$($migrationSecret):ConnectionString::")
